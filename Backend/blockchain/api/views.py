...
def pinata_file_upload(request, uid, id):
    ...
    for i in ls:
        ...
        for j in range(i['quantity']):
            ...
            headers = {
                'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Wj1JfXJmEkCKnNR6JYJiQEsKQVmZ_dv1arrRZbyxcZ4'
            }
    ...
    },
    {
        ...
        "type": "function"
            ...
            account_from = {
                "private_key": "0x7f66d0e36f46ce1a5d788077a5edd19dd11dbbc1a96b8ac3d6a2863579c94662",
            ...
            reset_tx = greeter.functions.safeMint(Web3.toChecksumAddress(address_to), token_id, time,
